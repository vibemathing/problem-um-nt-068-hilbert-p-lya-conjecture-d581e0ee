...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-068"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-v1",
      "problem_contract_sha256": "db142ec519c6f73ff0b34a231b230c5d0745a66f242cc33b47f51b00bc3f636e",
      "problem_id": "problem:um-nt-068-hilbert-p-lya-conjecture-d581e0ee",
      "route_id": "route:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-source-fidelity-01",
      "graph_id": "graph:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Do the nontrivial zeros of the Riemann zeta function correspond to eigenvalues of a self-adjoint operator?"
          },
          "statement_sha256": "403f090f4cdab653f01c8d2a84729ec2fcc9f43169466b97815653c411353762"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-root",
      "route_id": "route:um-nt-068-hilbert-p-lya-conjecture-d581e0ee-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-068-79185315e4bf",
        "url": "https://www.unsolvedmath.com/problems/NT-068"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
